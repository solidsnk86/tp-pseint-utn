...
SubAlgoritmo calcularMuros
	...
	// Pedimos que indique qu� espesor tendr� el muro (solo hay dos opciones 20 � 30 cm)
	Escribir 'Digite los centr�metros de espesor del muro a construir (20cm/30cm)';
	Leer espesor_muro;
...
// Mostramos al usuario la superficie total en m2
	...
	Escribir "Para su construcci�n necesitar�: ",cemento_final,"kg. de cemento, ",redon(ladrillos_final)," ladrillos y ",arena_final,"m3 de arena.";
	Escribir "";
FinSubAlgoritmo
...
subProceso calcularPintura
    ...
    Escribir "C�lculo de la cantidad de litros de pintura que necesita por superficie";
	Escribir "";
	Escribir "";
